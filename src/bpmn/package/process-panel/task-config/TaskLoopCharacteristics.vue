<template>
  <div>
    <div class="element-property input-property">
      <div class="element-property__label">会签：</div>
      <div class="element-property__value">
        <el-select v-model="loopCharacteristics" size="mini" @change="updateLoopCharacteristics">
          ...
          <el-option label="顺序会签" value="SequentialMultiInstance" />
 ...
 */
import { debounceBpmn } from "@/utils";
...
export default {
  ...
  created() {
    this.updateLoopCharacteristicsObject = debounceBpmn(this.updateLoopCharacteristicsObject, 200);
  },
  methods: {
