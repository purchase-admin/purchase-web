<template>
  <div class="app">
    <div class="top">
      ...
      <div class="content">
        <div class="table-top">长报集团采购预算计划清单</div>
    ...
    <el-dialog :visible.sync="centerDialogVisible" width="30%" center>
      ...
      <div>张三</div>
      <span>审批意见</span>
      <el-select v-model="yj" placeholder="选择意见" size="mini">
        <el-option label="常用审批意见" value="0"></el-option>
        <el-option label="拟同意" value="1"></el-option>
        <el-option label="请修改后重报" value="2"></el-option>
    ...
    <!-- 审批记录 -->
    <el-dialog :visible.sync="spjlDialogVisible" title="审批记录" width="50%">
      <el-table
        :data="spjltableData"
        style="width: 100%"
        tooltip-effect="dark"
      ...
      >
        ...
        <el-table-column prop="blbm" label="办理部门"> </el-table-column>
        <el-table-column prop="blr" label="办理人"> </el-table-column>
        ...
        <el-table-column prop="hs" label="耗时"> </el-table-column>
      </el-table>
      <span slot="footer" class="dialog-footer">
        <el-button @click="spjlDialogVisible = false">取 消</el-button>
        <el-button type="primary" @click="spjlDialogVisible = false"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
<script>
export default {
  name: "DeclareApprovalEditor",
  components: {},
  props: {},
  data() {
    return {
      spjlDialogVisible: false,
      spjltableData: [
        {
          hjmc: "起草",
          blbm: "法务中心",
