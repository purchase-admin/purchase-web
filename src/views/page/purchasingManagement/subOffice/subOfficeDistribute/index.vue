    ...
    <div class="top">
      <div class="head-form">
        ...
        <el-button
          ...
          >发布</el-button
        >
        <el-button type="primary" plain size="small" icon="el-icon-document"
          >采购申请审批单</el-button
        >
        <el-button
          type="primary"
      ...
      <div class="content">
        <div class="table-top">长报集团物资采购</div>
        <!-- table列表 -->
        <div class="table">
          <el-row type="flex">
            <el-col :span="3">
          ...
          <el-row type="flex">
            <el-col :span="24" style="height: 10px"><div></div></el-col>
          </el-row>
          ...
          <el-row type="flex">
            ...
            <el-col :span="7">
              <div>
                <el-select v-model="tableData.cgfs" placeholder="请选择">
                  <el-option label="供应商询价采购" value="0"></el-option>
                  <el-option label="综合评选采购" value="1"></el-option>
                  <el-option label="招标公司代理" value="2"></el-option>
                </el-select>
              </div>
            </el-col>
            <el-col :span="5">
            ...
            <el-col :span="19">
              <div>
                <el-checkbox-group v-model="tableData.checkList">
                  <el-checkbox :label="0">供应商1</el-checkbox>
                  <el-checkbox :label="1">供应商2</el-checkbox>
                  <el-checkbox :label="2">供应商3</el-checkbox>
                </el-checkbox-group>
              </div>
            </el-col>
          </el-row>
