...
export default {
  ...
  methods: {
    ...
    handleSee(row) {
      ...
      this.$router.push(`/purchaseProject/supplierManagement/review/detail/` + id + '/' + row.businessKey + '/' + this.queryParams.state)
      //外部跳转-pc
      // this.$router.push(`/outer/supplierManagement/review/detail/` + id + '/' + row.businessKey + '/' + this.queryParams.state)
      //外部跳转-mobile
      // this.$router.push(`/outer/mobile/supplierManagement/review/detail/` + id + '/' + row.businessKey + '/' + this.queryParams.state)
    }
  },
  created() {
    this.getList()
