<template>
  ...
  <div class="app-container taskMain">
    <div style="font-size: 18px; color: #303133;">供应商待办详情</div>
        ...
        <template slot-scope="props">
          <el-form label-position="left"
            ...
            <el-form-item label="法人代表">
              <span>{{ props.row.corporateRep }}</span>
            </el-form-item>
            <el-form-item label="业务联系人">
              <span>{{ props.row.businessContact }}</span>
            </el-form-item>
            <el-form-item label="联系电话">
              <span>{{ props.row.phone }}</span>
            </el-form-item>
            <el-form-item label="经营范围和主要产品及服务">
              <span>{{ props.row.businessScope }}</span>
            </el-form-item>
            <el-form-item label="结算方式">
              <span>{{ props.row.settlementModes }}</span>
            </el-form-item>
            <el-form-item label="供应商类型">
              <span>{{ props.row.supplierType }}</span>
            </el-form-item>
          </el-form>
        </template>
      </el-table-column>
...
import { getSupplier } from "@/api/supplier/supplier";
import { listRecord, listRecordByTask } from '@/api/budget/review'
export default {
  name: 'SupplierReviewDetailMobile',
  data() {
    return {
      open: false,
