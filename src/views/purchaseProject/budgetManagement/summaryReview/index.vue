...
export default {
  ...
  methods: {
    ...
    handleSee(row) {
      ...
      //正常跳转
      this.$router.push(`/purchaseProject/budgetManagement/summaryReview/detail/` + id + '/' + row.businessKey + '/' + this.queryParams.state)
      //外部跳转-pc
      // this.$router.push(`/outer/budgetManagement/summaryReview/detail/` + id + '/' + row.businessKey + '/' + this.queryParams.state)
      //外部跳转-mobile
      // this.$router.push(`/outer/mobile/budgetManagement/summaryReview/detail/` + id + '/' + row.businessKey + '/' + this.queryParams.state)
    }
  },
  created() {
    this.getList()
