<template>
  ...
  <div class="app-container taskMain">
    <div style="font-size: 18px; color: #303133;">年度预算汇总审核详情</div>
      ...
      <el-table-column type="expand">
        <template slot-scope="props">
          <el-form label-position="left"
            ...
            <el-form-item label="预算条数">
              <span>{{ props.row.budgetNum }}</span>
            </el-form-item>
            <el-form-item label="合计预算金额">
...
export default {
  name: 'BudgetSummaryReviewDetailMobile',
  data() {
    return {
      open: false,
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      listCollectBudget(this.$route.params.bizId).then(response => {
