<template>
  ...
  <div class="app-container taskMain">
    <div style="font-size: 18px; color: #303133;">申请审核详情</div>
        ...
        <template slot-scope="props">
          <el-form label-position="left"
            ...
            <el-form-item label="预算金额">
              <span>{{ props.row.budgetCost }}</span>
            </el-form-item>
            ...
            <!-- <el-form-item label="供应商联系人">
                <span>{{ props.row.supplierContactName }}</span>
              </el-form-item>
              <el-form-item label="供应商联系电话">
                <span>{{ props.row.supplierContactPhone }}</span>
              </el-form-item> -->
            <!-- <el-form-item label="预算类型">
                <span>{{ props.row.budgetType }}</span>
              </el-form-item> -->
          </el-form>
        </template>
      </el-table-column>
