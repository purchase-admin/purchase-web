  ...
  <div class="app-container"
    ...
    <a-descriptions title="设置"
      ...
      <!-- <a-descriptions-item label="是否公开">
            <el-switch v-model="form.isOpen" active-value="1" inactive-value="0" v-if="!confirmSelectType"></el-switch>
